...
if __name__ == "__main__":
    ...
    results = get_results("../train_models/legal-bert-small-4",
                          gt_dict, verbose=True)
    save_results("./results", "../train_models/legal-bert-small-4", results)

    results_per_cat = {}
    cat_dict = get_questions_from_csv()
    for key in cat_dict.keys():
        key_results = get_results_per_cat(
            "../train_models/legal-bert-small-4", gt_dict, key, verbose=False)
        results_per_cat.update({key: key_results})
    save_results(
        "./results", "../train_models/legal-bert-small-cat-4", results_per_cat)
